...
keyb.buttons += [Button([" .----","","","","","","",""], [0,0,0,0,4,4,4,4])] # 11 1
keyb.buttons += [Button([" ..---","","","","","","",""], [0,0,0,0,4,4,4,4])] # 12 2
keyb.buttons += [Button([" ...--","","","","","","",""], [0,0,0,0,4,4,4,4])] # 13 3
keyb.buttons += [Button([" ....-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 14 4
keyb.buttons += [Button([" .....","","","","","","",""], [0,0,0,0,4,4,4,4])] # 15 5
keyb.buttons += [Button([" -....","","","","","","",""], [0,0,0,0,4,4,4,4])] # 16 6
keyb.buttons += [Button([" --...","","","","","","",""], [0,0,0,0,4,4,4,4])] # 17 7
keyb.buttons += [Button([" ---..","","","","","","",""], [0,0,0,0,4,4,4,4])] # 18 8
keyb.buttons += [Button([" ----.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 19 9
keyb.buttons += [Button([" -----","- ","","","","","",""], [0,0,0,0,4,4,4,4])] # 20 0

keyb.buttons += [Button([" --.-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 21 q
keyb.buttons += [Button([" .--","","","","","","",""], [0,0,0,0,4,4,4,4])] # 22 w
keyb.buttons += [Button([" .","","","","","","",""], [0,0,0,0,4,4,4,4])] # 23 e
keyb.buttons += [Button([" .-.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 24 r
keyb.buttons += [Button([" -","","","","","","",""], [0,0,0,0,4,4,4,4])] # 25 t
keyb.buttons += [Button([" -.--","","","","","","",""], [0,0,0,0,4,4,4,4])] # 26 y
keyb.buttons += [Button([" ..-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 27 u
keyb.buttons += [Button([" ..","","","","","","",""], [0,0,0,0,4,4,4,4])] # 28 i
keyb.buttons += [Button([" ---","","","","","","",""], [0,0,0,0,4,4,4,4])] # 29 o
keyb.buttons += [Button([" .--.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 30 p

keyb.buttons += [Button([" .-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 31 a
keyb.buttons += [Button([" ...","","","","","","",""], [0,0,0,0,4,4,4,4])] # 32 s
keyb.buttons += [Button([" -..","","","","","","",""], [0,0,0,0,4,4,4,4])] # 33 d
keyb.buttons += [Button([" ..-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 34 f
keyb.buttons += [Button([" --.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 35 g
keyb.buttons += [Button([" ....","","","","","","",""], [0,0,0,0,4,4,4,4])] # 36 h
keyb.buttons += [Button([" .---","","","","","","",""], [0,0,0,0,4,4,4,4])] # 37 j
keyb.buttons += [Button([" -.-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 38 k
keyb.buttons += [Button([" .-..","","","","","","",""], [0,0,0,0,4,4,4,4])] # 39 l
keyb.buttons += [Button(["","","","","","","",""], [0,0,0,0,4,4,4,4])] # 40 , ;

keyb.buttons += [Button([" --..","","","","","","",""], [0,0,0,0,4,4,4,4])] # 41 z
keyb.buttons += [Button([" -..-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 42 x
keyb.buttons += [Button([" -.-.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 43 c
keyb.buttons += [Button([" ...-","","","","","","",""], [0,0,0,0,4,4,4,4])] # 44 v
keyb.buttons += [Button(["   ","","","","","","",""], [0,0,0,0,4,4,4,4])] # 45 SPACE
keyb.buttons += [Button([" -...","","","","","","",""], [0,0,0,0,4,4,4,4])] # 46 b
keyb.buttons += [Button([" -.","","","","","","",""], [0,0,0,0,4,4,4,4])] # 47 n
keyb.buttons += [Button([" --","","","","","","",""], [0,0,0,0,4,4,4,4])] # 48 m
keyb.buttons += [Button([" -.. --- -","","","","","","",""], [0,0,0,0,4,4,4,4])] # 49 . ?
