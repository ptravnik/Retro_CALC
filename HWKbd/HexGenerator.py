...
keyb.buttons += [Button(["z","A","","","а","А","",""], [0,0,0,0,4,4,4,4])] # 41 z
keyb.buttons += [Button(["x","S","","","с","С","",""], [0,0,0,0,4,4,4,4])] # 42 x
keyb.buttons += [Button(["c","D","","","д","Д","",""], [0,0,0,0,4,4,4,4])] # 43 c
keyb.buttons += [Button(["v","F","","","ф","Ф","",""], [0,0,0,0,4,4,4,4])] # 44 v
keyb.buttons += [Button([" ","_","","","ч","Ч","",""], [0,0,0,0,4,4,4,4])] # 45 SPACE
keyb.buttons += [Button(["b","J","","","й","Й","",""], [0,0,0,0,4,4,4,4])] # 46 b
keyb.buttons += [Button(["n","K","","","к","К","",""], [0,0,0,0,4,4,4,4])] # 47 n
keyb.buttons += [Button(["m","L","","","л","Л","",""], [0,0,0,0,4,4,4,4])] # 48 m
